...
CREATE TABLE IF NOT EXISTS `PACIENTE` (
  ...
  PRIMARY KEY (`PAC_CODIGO`, `RECEPCIONISTA_REC_CODIGO`),
  CONSTRAINT `fk_PACIENTE_PESSOA`
    FOREIGN KEY (`PAC_CODIGO`)
    REFERENCES `PESSOA` (`PES_CODIGO`)
    ON DELETE NO ACTION
    ON UPDATE RESTRICT,
  CONSTRAINT `fk_PACIENTE_RECEPCIONISTA`
